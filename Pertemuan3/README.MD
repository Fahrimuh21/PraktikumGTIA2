...
![Proyeksi](Pertemuan3/Images/Proyeksi.png)
...
![Kubus Berotasi](Pertemuan3/Images/KubusBerotasi.png)
...
![Lengan Bergerak](Pertemuan3/Images/LenganBergerak.png)
...
* `w / W` → menggerakkan telapak tangan
* `f / F` → menggerakkan jari
